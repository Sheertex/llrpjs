...
import { GetDataType, GetDataTypeFromFD, GetDefFromRef, GetParamClassType, GetSubTypeRefs, GetTypedParamCtrArgs, Id, LLRPAllTypeDefinitions, LLRPDataValue, LLRPParameterI, LLRPParamNames, LLRPUserData } from '../types'
...
> extends LLRPProxyParameter<DT, N> {
  ...
  static ofType<AD extends LLRPAllTypeDefinitions, N extends LLRPParamNames<AD>, TD extends AD[N] = AD[N], DT extends GetDataType<AD, TD> = GetDataType<AD, TD>>(Def: AD, Name?: N) {
    class _LLRPTypedParameter extends this<AD, N, TD, DT> {
      ...
      constructor(args?: GetTypedParamCtrArgs<LLRPParameterI<DT, N>> | _LLRPParameter<DT, N> | Buffer) {
        if (args instanceof _LLRPParameter || args instanceof Buffer) {
          super(args as any)
        } else super({ data: {}, ...args, ...{ type: Name } })
      }
    }
